...
glm::mat4 Projeccio_Orto(GLuint sh_programID, int minx, int miny, GLsizei w, GLsizei h, double zoom)
{   
	glm::mat4 MatriuProjeccio(1.0);
	glViewport(minx, miny, w, h);
	if (h == 0) h = 1;
	MatriuProjeccio = glm::ortho((GLfloat)5.f, (GLfloat)-5.f, (GLfloat)5.f, (GLfloat)-5.f, (GLfloat)5.f, (GLfloat)-5.f);
...
// Iluminacio movent-se amb la camara (abans gluLookAt)
	...
	MatriuVista = glm::lookAt(cam, vec3(0, 0, 0), up);
